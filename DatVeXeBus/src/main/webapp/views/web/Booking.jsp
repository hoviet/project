            ...
            <section class="slider" id="spiderman">
                <div class="container">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#DanhSachNguoiDung" role="tab" data-toggle="tab">Chọn Ghế</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#DanhSachKhoaHoc" role="tab" data-toggle="tab">Thông Tin Khách Hàng</a>
                        </li>
                                ...
                                <div class="content-book3">
                                    <div class="content-imgg1">
                                        <div class="card mb-3" style="width: 28rem;height: 350px;">
                                            <div class="card-body ">
                                                <label style="color:rgb(226, 70, 72);padding-left: 150px;">gắn thông tin vào</label>
                                                <div class="lable">
                                                    <label for="">Tuyến Xe</label>
                                                </div>
                                                <label for="" style="color: red;border-bottom: 1px solid grey;width: 300px;">Chuyển Dữ Liệu Vào</label>
                                                <div class="lable2">
